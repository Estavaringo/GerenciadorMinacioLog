                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="POST" action="Executa">
                                                            ...
                                                            <input type="hidden" name="atividade" value=${tipoCliente.codigo}>
                                                            <button type="submit" class="btn btn-default" value="Incluir Correcao"><i class="material-icons" style="font-size: 24px">delete</i></button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            </c:forEach>
