                                ...
                                <c:if test="${not empty listaTipoCliente}">
                                    <c:forEach var="tipoCliente" items="${listaTipoCliente}">
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Dropdown Trigger -->
                                                <a class='dropdown-button btn-floating red darken-2' href='#' data-constrainwidth="false" data-activates='dropdown${tipoCliente.codigo}'><i class="material-icons">more_horiz</i></a>
                                                ...
                                                <ul id='dropdown${tipoCliente.codigo}' class='dropdown-content'>
                                                    ...
                                                    <li class="divider"></li>
                                                    <li><a class="botao-excluir grey-text text-darken-4" id="${tipoCliente.codigo}"><i class="material-icons deep-orange-text">delete</i>Excluir</a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </c:forEach>
