        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m9">
                    ...
                    <h4 class="light deep-orange-text text-lighten-4 center-on-small-only">Cadastro de Tipos de Clientes.</h4>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <ul id='dropdown${tipoContato.codigo}' class='dropdown-content'>
                                                    ...
                                                    <li class="divider"></li>
                                                    <li><a class="botao-excluir grey-text text-darken-4" id="${tipoContato.codigo}"><i class="material-icons deep-orange-text">delete</i>Excluir</a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </c:forEach>
