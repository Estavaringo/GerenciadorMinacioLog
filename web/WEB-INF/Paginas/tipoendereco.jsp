    ...
    <body>
        <header>
            ...
            <ul id="slide-out" class="side-nav fixed">
                ...
                <li class="bold"><a href="#" class="waves-effect waves-teal">Enderecos</a>
                </li>
                <li class="no-padding">
                            ...
                            <div class="collapsible-body" style="display: block;">
                                <ul>
                                    <!--Para deixar algum item ativado, adicionar class="active" -->
                                        ...
                                        <li class="active"><a href="Executa?logicaDeNegocio=TipoEnderecoServlet&tarefa=consultarLista">Tipo de Endereço</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m9">
                            ...
                            <h4 class="light cyan-text text-lighten-4 center-on-small-only">Cadastro de Tipos de Enderecos.</h4>
                        </div>
                    </div>
                </div>
            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="POST" action="Executa">
                                                            ...
                                                            <input type="hidden" name="codigo" value=${tipoEndereco.codigo}>
                    ...
                    <div class="col hide-on-small-only m3 l2">
                        <div class="tabs-wrapper" style="top: 0px;">
                            <ul class="section table-of-contents">
                                <li><a href="#Lista">Tipos de Enderecos</a></li>
